...
<input type="password" id="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="Enter your password">
    ...
    <div class="text-center d-grid">
        ...
        <footer class="footer footer-alt">
            2024 - <script>document.write(new Date().getFullYear())</script> &copy; A2i Multibel by <a href="" class="text-white-50">Company</a> 
        </footer>
        ...
        <!-- App js -->
        <script src="{{asset('backend/assets/js/app.min.j')}}s"></script>
