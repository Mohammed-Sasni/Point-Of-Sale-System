...
<div class="row">
    ...
    <div class="col-md-12">
     ...
     <div class="col-md-12">
        <div class="mb-3">
            ...
            <input type="hidden" name="date" class="form-control" value="{{date('d-m-Y')}}"  value="{{$expense->date}}">
     ...
     <div class="col-md-12">
        <div class="mb-3">
            ...
            <input type="hidden" name="month" class="form-control" value="{{date('F')}}"  value="{{$expense->month}}">
    ...
    <div class="col-md-12">
        <div class="mb-3">
            ...
            <input type="hidden" name="year" class="form-control " value="{{date('Y')}}" value="{{$expense->year}}">
