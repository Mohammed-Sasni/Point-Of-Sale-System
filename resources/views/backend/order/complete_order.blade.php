                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Complete Oders</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
    ...
    <tr>
        ...
        <td> 
            @if($item->customer && $item->customer->image)
                <img src="{{ asset($item->customer->image) }}" style="width: 50px; height: 40px;" alt="Customer Image"> 
            @else
                <img src="{{ asset('default-avatar.png') }}" style="width: 50px; height: 40px;" alt="Default Image">
            @endif
        </td>
