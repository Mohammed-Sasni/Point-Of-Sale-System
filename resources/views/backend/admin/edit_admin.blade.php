     ...
     <form id="myForm" method="post" action="{{ route('admin.update') }}" enctype="multipart/form-data">
       ...
       <input type="hidden" name="id" value="{{$adminuser->id}}">
                        ...
                        <h5 class="mb-4 text-uppercase">
                            <i class="mdi mdi-account-circle me-1"></i> Edit Admin
                        </h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
            <div class="form-group mb-3">
            <label class="form-label">Asing Roles</label>
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                ...
                photo: { required : 'Please Enter User Name' },
                password: { required : 'Please Select User Photo' },
                roles: { required : 'Please Select User Roles' },
