...
//////////////////////////// Pay Salary All Mwthod ////////////////////////////
   ...
   /*public function MonthHistorySalary($id) {
    
    $monthhistory = Employee::with('advance')->findOrFail($id);
    return view('backend.salary.month_history', compact('monthhistory'));
    }*/
}
